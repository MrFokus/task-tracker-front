...
<template>
    <main class="padding-page">
        <TitleBase title="Личные проекты" description="Здесь вы можете управлять и отслеживать личные проекты."
            :link-back="{ name: 'Вернуться назад на главную', path: '/' }">
        </TitleBase>
        <hr>
        <section class="project-container white-block">
            <div class="title-container">
                ...
                <div class="management-container">
                    ...
                    <div class="toggle-type-view">
                        <button class="white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                fill="none">
                                <path d="M2.5 10H17.5M2.5 5H17.5M2.5 15H17.5" stroke="#344054" stroke-width="1.67"
                                    stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </button>
                        <button class="white select">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                fill="none">
                                <path
...
<style scoped lang="scss">
    ...
    .project-container{
        ...
        .projects{
            width: 100%;
            display: grid;
            grid-template-columns: repeat(auto-fill,minmax(17rem,1rem));
            gap: 1.5rem;
